...
module ApplicationHelper
  ...
  def fortune
    ...
    "You did wha... oh <em>dear</em>....",
    "CPU needs bearings repacked",
    "Too many little pins on CPU confusing it, bend back and forth until 10-20% are neatly removed. Do <em>not</em> leave metal bits visible!",
    "<em>Rosin</em> core solder? But...",
    ...
    "Don't worry; it's been deprecated. The new one is worse."].rand.capitalize
  end
end
